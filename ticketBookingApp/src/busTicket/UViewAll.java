...
public class UViewAll extends javax.swing.JInternalFrame {
    ...
    public UViewAll() {
        ...
        try
        {
            ...
            while(rs.next())
            {
                model.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(4),rs.getString(3),rs.getString(5),rs.getString(6)});
            }
        }
        catch(Exception  e)
        {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Email", "Gender", "Age", "Username", "Password"
            }
        ) {
